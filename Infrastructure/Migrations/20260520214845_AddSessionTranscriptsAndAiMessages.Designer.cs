...
namespace API.Migrations
{
    ...
    [Migration("20260520214845_AddSessionTranscriptsAndAiMessages")]
    partial class AddSessionTranscriptsAndAiMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.SessionAiMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PsychologistUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentId", "PsychologistUserId", "Timestamp");

                    b.ToTable("SessionAiMessages");
                });

            modelBuilder.Entity("Domain.Entities.SessionMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.SessionNote", b =>
                {
                    ...
                    b.HasIndex("AppointmentId", "PsychologistUserId")
                        .IsUnique();

                    b.ToTable("SessionNotes");
                });

            modelBuilder.Entity("Domain.Entities.SessionTranscript", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentId", "Timestamp");
            ...
            modelBuilder.Entity("Domain.Entities.UserCategoryApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserCategoryApplications");
                });
